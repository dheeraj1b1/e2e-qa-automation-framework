...
public class BaseApiTest {
    ...
    public void setup() {
        // --- THE MAGIC FIX ---
        // This sets the URL Globally. Now 'given()' will ALWAYS go here.
        RestAssured.baseURI = "https://fakestoreapi.com";

        // This tricks Cloudflare for EVERY request automatically
        RestAssured.given().header("User-Agent",
                "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36");

        // Optional: Print logs if validation fails
